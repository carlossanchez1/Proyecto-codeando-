				...
				<div id="content">
					<div class="post">
					  <h2 class="title"><a href="#">BIENVENIDO A CODEANDO</a></h2>
						...
						<div class="entry">
							<p>This is <strong>Boosting	</strong>, a free, fully standards-compliant CSS template designed by FreeCssTemplates for <a>Free CSS Templates</a>.	This free template is released under a <a>Creative Commons Attributions 2.5</a> license, so you’re pretty much free to do whatever you want with it (even use it commercially) provided you keep the links in the footer intact. Aside from that, have fun with it :)</p>
